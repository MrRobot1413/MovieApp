package ru.mrrobot1413.lesson8homework.data
...
object DataStorage {
    var moviesList: MutableList<Movie> = mutableListOf(
        Movie(
            ...
            R.string.movie_1_release_date,
            R.string.movie_1_country,
            R.string.movie_1_restriction,
        ...
        Movie(
            ...
            R.string.movie_2_release_date,
            R.string.movie_2_country,
            R.string.movie_2_restriction,
        ...
        Movie(
            ...
            R.string.movie_3_release_date,
            R.string.movie_3_country,
            R.string.movie_3_restriction,
        ...
        Movie(
            ...
            R.string.movie_4_release_date,
            R.string.movie_4_country,
            R.string.movie_4_restriction,
        ...
        Movie(
            ...
            R.string.movie_5_release_date,
            R.string.movie_5_country,
            R.string.movie_5_restriction,
